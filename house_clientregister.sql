...
LOCK TABLES `clientregister` WRITE;
/*!40000 ALTER TABLE `clientregister` DISABLE KEYS */;
INSERT INTO `clientregister` VALUES (1,'ALBIN','THOMAS','albint.mca2325@saintgits.org','9496161839','male','albinthomas','albinthomas','Albin thomas, saintgits college of engineering','kottayam'),(1,'avj','avj','avj@gmail.com','4456464645','male','avj','avj','dgdg','dgdg');
