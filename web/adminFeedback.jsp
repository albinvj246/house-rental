...
.feedback-table {
    ...
    overflow-x: auto; /* Allow horizontal scrolling if needed */
    margin-right: 20px; /* Add space between tables */
    width: 48%; /* Set width of table container */
}
...
<body>
    <div class="container">
        <font color="white" ><b><h1 class="text-center">Feedback Overview</h1></font></b>
        <div class="feedback-container">
            ...
            <div class="feedback-table">
                ...
                <table>
                    ...
                    <%
                        // Database connection and data retrieval for user feedback
                        connection = null;
                        statement = null;
                        resultSet = null;
                        ...
                        try {
                            ...
                            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/house", "root", "Albin##123");
                            statement = connection.createStatement();
                            resultSet = statement.executeQuery("SELECT * FROM feedbackuser");
