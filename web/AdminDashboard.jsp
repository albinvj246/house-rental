...
<li class="nav-item">
                                ...
                                <div class="card border-left-primary shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"><font size ="4">House</font></div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1"><font size="4">Client</font></div>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-info shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><font size="4">Users</font></div>
                                                <div class="row no-gutters align-items-center">
                                                    <div class="col-auto">
    ...
    // First query
    String clientQuery = "SELECT COUNT(*) FROM feedback";
    ResultSet rs = st.executeQuery(clientQuery);
    int clientFeedbackCount = 0;
    if (rs.next()) {
        clientFeedbackCount = rs.getInt(1);
    }

    // Second query
    String userQuery = "SELECT COUNT(*) FROM feedbackuser";
    ResultSet rss = st.executeQuery(userQuery);
    int userFeedbackCount = 0;
    if (rss.next()) {
        userFeedbackCount = rss.getInt(1);
    }

    // Calculate total feedback
    int totalFeedback = clientFeedbackCount + userFeedbackCount;
    %>
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1"><font size="4">Feedback's</font></div>
                                                 <div class="col-auto">
                                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"> <%= totalFeedback%></div>
                                                    </div>
                                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><font size="2"> CLIENT : <%=clientFeedbackCount%> &nbsp;&nbsp; USERS : <%=userFeedbackCount%></font></div>
                                            </div>
                                            <div class="col-auto">
